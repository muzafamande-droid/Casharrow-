...
// CashArrow now uses provider-confirmed automatic deposits. Remove the old
// manual deposit POST/approval handlers from the production route stack so a
// deposit can never be credited through the retired admin workflow.
