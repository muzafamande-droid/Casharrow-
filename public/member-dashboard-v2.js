(() => {
  ...
  style.textContent = `
    ...
    .ca2rental .ca-series-tabs{display:flex!important;overflow-x:auto!important;gap:6px!important;scrollbar-width:none!important;padding:1px 1px 8px!important}.ca2rental .ca-series-tabs::-webkit-scrollbar{display:none}
    ...
    .ca2rental .ca-series-panel{background:#071a38!important;color:#fff!important;border-radius:12px!important;padding:9px!important;box-shadow:none!important}.ca2rental .ca-series-panel.active{display:block!important}
    .ca2rental .ca-product{grid-template-columns:34px 1fr auto!important;gap:7px!important;padding:8px 0!important;border-bottom:1px solid #ffffff12!important}.ca2rental .ca-product img{width:34px!important;height:34px!important;border-radius:8px!important}
    .ca2rental .ca-product h3{font-size:11px!important}.ca2rental .ca-product p{font-size:9px!important;line-height:1.3!important;color:#9fb4d5!important}.ca2rental .ca-product button{padding:6px 8px!important;border-radius:8px!important;font-size:10px!important}.ca2rental .ca-note{font-size:10px!important;color:#9fb4d5!important;margin:2px 0 7px!important}
    .ca2allnote{font-size:10px;color:#9fb4d5;margin:0 0 7px}@media(max-width:420px){.ca2lowergrid{grid-template-columns:repeat(3,1fr)}.ca2lowergrid button{font-size:10px}.ca2rental .ca-product{grid-template-columns:32px 1fr auto!important}}
  `;
  ...
  function setupAllTab() {
    ...
    all.onclick=()=>{
      ...
      const rows=[];panels.querySelectorAll('.ca-product').forEach(row=>{const m=(row.querySelector('p')?.textContent||'').match(/Rental:\s*UGX\s*([\d,]+)/i);rows.push({row,fee:m?Number(m[1].replace(/,/g,'')):0});});rows.sort((a,b)=>a.fee-b.fee);
