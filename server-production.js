...
app.get("/member.html", (req, res) => {
  try {
    ...
    const scripts = '<script src="/rental-catalog.js?v=custom-machines-1"></script><script src="/aveilot-machine-catalog-fix.js?v=4"></script><script src="/aveilot-withdrawal-fee.js?v=2"></script>';
