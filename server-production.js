...
app.get("/", (req, res) => {
  ...
  const scripts = '<script src="/member-dashboard-v2.js?v=5"></script><script src="/casharrow-ui-fixes.js?v=1"></script><script src="/rental-catalog.js?v=final5"></script><script src="/casharrow-machine-designs.js?v=2"></script>';
